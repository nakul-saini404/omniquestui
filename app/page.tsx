        ...
        >
          ...
          <div className="hero-grid" style={{ maxWidth: 1200, margin: "0 auto", padding: "80px 24px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center", position: "relative", zIndex: 2, flex: 1 }}>
            ...
            <div>
              ...
              {/* H1 */}
              <h1 className="animate-fade-up delay-1" style={{ fontFamily: "var(--font-head)", fontSize: "clamp(2.4rem,3.5vw,3.8rem)", fontWeight: 800, color: "white", lineHeight: 1.1, marginBottom: 24 }}>
                We Design<br />
          ...
          <div style={{ maxWidth: 1200, margin: "0 auto", padding: "72px 24px 0" }}>
            <div className="footer-grid" style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 48, marginBottom: 48 }}>
              <div>
                ...
                {[
                  { label: "Main Office", addr: "1210, Galleria Boulevard, DLF Phase IV, Gurugram, Haryana 122009" },
                  { label: "Regional Office", addr: "F-45, First Floor, South City II, Sector 50, Gurugram, Haryana 122018" },
                  { label: "Corporate Office", addr: "Bangalore Alpha Lab, #1316/C, 1st Floor, 9th Cross, J.P. Nagar 2nd Phase, Bangalore – 560078" },
                ].map(office => (
                  <div key={office.label} style={{ marginBottom: 16, marginTop: 10 }}>
                    <div style={{ fontSize: ".68rem", fontWeight: 700, letterSpacing: ".08em", textTransform: "uppercase", color: "rgba(255,255,255,.45)", marginBottom: 4 }}>
                      {office.label}
                    </div>
                    <p style={{ fontSize: ".78rem", lineHeight: 1.7, color: "rgba(255,255,255,.28)", margin: 0, maxWidth: 280 }}>
                      {office.addr}
                    </p>
                  </div>
                ))}
