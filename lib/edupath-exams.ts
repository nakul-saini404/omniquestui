...
// ─── Full Intake Timeline (2026–2027) ──────────────────────────────────────────
...
export const INTAKE_TIMELINE_2027: IntakeTimelineEvent[] = [
  {
    ...
    description: "Compare QS rankings, tuition, career outcomes, scholarships. Shortlist 12–15 universities across reach/target/safety. Attend virtual open days and info sessions.",
  ...
  },
  {
    ...
    description: "Start English test prep immediately. Aim to sit the exam by Jun–Jul 2026. This leaves time for one retake before Jan 2027 deadlines. Target 7.0+ for most universities.",
  ...
  },
  {
    ...
    description: "Start SAT prep using Khan Academy + Bluebook app. Target 6+ months for a 1400+ score. First sitting ideally August 2026. Use College Board's free personalised practice.",
    countries: ["USA"],
    type: "prep", urgent: true,
  },
  {
    id: "t04", dateLabel: "Feb–Apr 2026", month: 1, year: 2026,
    title: "Apply for APS Certificate (Germany — URGENT, do FIRST)",
    description: "MANDATORY for all Indian students applying to Germany. Apply at aps-india.de immediately. Takes 4–8 weeks. Without APS your German visa WILL be refused.",
    countries: ["Germany"],
    type: "register", urgent: true,
  },
  {
    id: "t05", dateLabel: "Apr–Jun 2026", month: 3, year: 2026,
    title: "Begin TMUA & ESAT preparation (UK — Maths/Engineering/Science)",
    description: "Start preparing for TMUA (Maths/Economics/CS at Cambridge/LSE/Warwick) and ESAT (Engineering/Science at Cambridge/Imperial) for Oct–Nov 2026 sittings. Use past ENGAA/NSAA/TMUA papers.",
    countries: ["UK"],
    type: "prep", urgent: false,
  },
  {
    id: "t06", dateLabel: "Jun–Jul 2026", month: 5, year: 2026,
    title: "Sit IELTS Academic / TOEFL exam — first attempt",
    description: "Take your English proficiency test. Computer-delivered IELTS results in 3–5 days. If score is below target, book a retake for Sep–Oct 2026 — last practical chance before Jan deadlines.",
    countries: ["USA","UK","Canada","Australia","Netherlands","Singapore"],
    type: "exam", urgent: true,
  },
  {
    id: "t07", dateLabel: "Aug 23, 2026", month: 7, year: 2026,
    title: "SAT first attempt (Aug 23 sitting)",
    description: "Sit SAT on Aug 23. Results arrive in ~2 weeks. If below 1300 consider retake on Oct 4. If 1350+ consider retake only to push past 1450+. Register at sat.collegeboard.org now.",
    countries: ["USA"],
    type: "exam", urgent: true,
  },
  {
    id: "t08", dateLabel: "Aug 1, 2026", month: 7, year: 2026,
    title: "Common App opens — set up profile immediately",
    description: "Common App launches August 1. Create account, fill academics and activities (up to 10). Begin essay brainstorming. Request teacher recommendations NOW — give teachers 6+ weeks.",
    countries: ["USA"],
    type: "apply", urgent: true,
  },
  {
    id: "t09", dateLabel: "Aug–Sep 2026", month: 7, year: 2026,
    title: "UCAS application opens — begin Personal Statement",
    description: "UCAS opens for 2027 intake. Start your 4,000-character Personal Statement (75% on your subject, 25% activities). Choose 5 UK university choices carefully.",
    countries: ["UK"],
    type: "apply", urgent: true,
  },
  {
    id: "t10", dateLabel: "Aug 2026", month: 7, year: 2026,
    title: "Register for TMUA and ESAT (UK applicants)",
    description: "Registration opens at admissionstesting.org in August. Register immediately — Indian test centre slots are strictly limited. Pay ~£75 per exam. Select your module choices for ESAT.",
    countries: ["UK"],
    type: "register", urgent: true,
  },
  {
    id: "t11", dateLabel: "Sep–Oct 2026", month: 8, year: 2026,
    title: "IELTS / TOEFL retake if needed",
    description: "If June/July score was below target, retake in Sep–Oct. This is your last practical chance to have results before most Jan 2027 application deadlines.",
    countries: ["USA","UK","Canada","Australia","Netherlands","Singapore"],
    type: "exam", urgent: false,
  },
  {
    id: "t12", dateLabel: "Oct 4 & Nov 1, 2026", month: 9, year: 2026,
    title: "SAT retake opportunities",
    description: "Oct 4 results arrive before most Nov 1 Early Decision deadlines. Nov 1 results may arrive too late for some ED schools — plan accordingly. Register at sat.collegeboard.org.",
    countries: ["USA"],
    type: "exam", urgent: false,
  },
  {
    id: "t13", dateLabel: "Oct 15, 2026", month: 9, year: 2026,
    title: "UCAS deadline: Oxford & Cambridge (HARD DEADLINE)",
    description: "Hard deadline for all Oxford and Cambridge UCAS applications. No extensions under any circumstances. Ensure TMUA/ESAT registration confirmed. Personal Statement must be final.",
    countries: ["UK"],
    type: "apply", urgent: true,
  },
  {
    id: "t14", dateLabel: "Oct–Nov 2026", month: 9, year: 2026,
    title: "TMUA & ESAT exams",
    description: "Sit TMUA (Mathematical Reasoning) and/or ESAT (Engineering & Science) in October–November. Scores automatically sent to your UCAS-listed universities.",
    countries: ["UK"],
    type: "exam", urgent: true,
  },
  {
    id: "t15", dateLabel: "Nov 1–15, 2026", month: 10, year: 2026,
    title: "USA: Early Decision & Early Action deadlines",
    description: "Most ED deadlines: Nov 1 (MIT, UChicago, many others) or Nov 15 (Georgia Tech, CMU). ED is binding — only apply if that university is your absolute first choice and finances are clear.",
    countries: ["USA"],
    type: "apply", urgent: true,
  },
  {
    id: "t16", dateLabel: "Dec 1–15, 2026", month: 11, year: 2026,
    title: "USA: Early Decision results released",
    description: "ED results typically released Dec 12–15. Admitted (binding — withdraw all other apps). Deferred (continue with Regular Decision). Rejected (apply Regular Decision elsewhere).",
    countries: ["USA"],
    type: "decision", urgent: false,
  },
  {
    id: "t17", dateLabel: "Jan 1–15, 2027", month: 0, year: 2027,
    title: "USA Regular Decision & UCAS final deadline — NO EXTENSIONS",
    description: "Jan 1: Most US Regular Decision deadlines (MIT, Yale, Princeton, Stanford, Harvard). Jan 15: UCAS final deadline for all non-Oxbridge UK courses. Submit complete applications — no extensions.",
    countries: ["USA","UK"],
    type: "apply", urgent: true,
  },
  {
    id: "t18", dateLabel: "Nov 2026–Feb 2027", month: 10, year: 2026,
    title: "Canadian university application deadlines",
    description: "UoT: Jan 13. UBC: Jan 15. McGill: Jan 15. Waterloo: varies by program. Check each university. Apply Study Permit as soon as acceptance arrives — processing takes 8–12 weeks.",
    countries: ["Canada"],
    type: "apply", urgent: true,
  },
  {
    id: "t19", dateLabel: "Jan–Apr 2027", month: 0, year: 2027,
    title: "Australian & Netherlands application deadlines",
    description: "Netherlands: rolling admissions, apply as early as possible — many programmes fill by March. Australia: Feb intake started; July 2027 intake applications accepted Jan–Apr.",
    countries: ["Australia","Netherlands"],
    type: "apply", urgent: false,
  },
  {
    id: "t20", dateLabel: "Mar–Apr 2027", month: 2, year: 2027,
    title: "Admission decisions — USA Regular Decision & UK/other offers",
    description: "US Regular Decision results: end of March. UK UCAS offers rolling from Jan–April. Singapore: Feb–April. Compare all offers. Request financial aid award letters from US universities.",
    countries: ["USA","UK","Canada","Australia","Singapore","Netherlands"],
    type: "decision", urgent: false,
  },
  {
    id: "t21", dateLabel: "May 1, 2027", month: 4, year: 2027,
    title: "USA: National Candidate Reply Date — finalise your choice",
    description: "May 1 is the universal US enrollment deadline. Accept your chosen offer and pay deposit. Decline all other US offers on the same day. Compare financial aid packages before deciding.",
    countries: ["USA"],
    type: "decision", urgent: true,
  },
  {
    id: "t22", dateLabel: "May–Jun 2027", month: 4, year: 2027,
    title: "Receive key visa documents (I-20 / CAS / Admission Letter)",
    description: "USA: I-20 issued after paying deposit. UK: CAS issued after meeting all conditions. Germany: unconditional admission letter. Apply for visa IMMEDIATELY after receiving your document.",
    countries: ["USA","UK","Germany","Canada","Australia","Netherlands","Singapore"],
    type: "visa", urgent: true,
  },
  {
    id: "t23", dateLabel: "Jun–Jul 2027", month: 5, year: 2027,
    title: "Apply for student visa — all countries",
    description: "USA: Book F-1 interview immediately at ustraveldocs.com/in — slots vanish. UK: Apply online + VFS biometrics. Canada: Study Permit at canada.ca. Germany: Consulate appointment. Australia: ImmiAccount.",
    countries: ["USA","UK","Canada","Australia","Germany","Netherlands","Singapore"],
    type: "visa", urgent: true,
  },
  {
    id: "t24", dateLabel: "Aug 14, 2027", month: 7, year: 2027,
    title: "UK A-level results & UCAS confirmation",
    description: "UK A-level results day. UCAS automatically confirms or releases places based on grades. Clearing available if grades not met. Indian 12th marksheets: UCAS adjusts for Indian boards.",
    countries: ["UK"],
    type: "decision", urgent: false,
  },
  {
    id: "t25", dateLabel: "Aug–Sep 2027", month: 7, year: 2027,
    title: "Pre-departure preparation & travel",
    description: "Book flights 2–3 months ahead for best prices. Arrange university halls or PG accommodation. Get multi-currency forex card. Medical checkup + vaccinations. Prepare document folder. Most courses start Sep 2027.",
    countries: ["USA","UK","Canada","Australia","Germany","Netherlands","Singapore","Japan","India"],
