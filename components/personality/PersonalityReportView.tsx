...
export default function PersonalityReportView({
  ...
  const r = 60,
    circ = 2 * Math.PI * r,
    dash = (report.overallScore / 100) * circ;
  ...
  return (
    <div style={{ animation: "fadeUp .6s ease both", color: "white" }}>
      ...
      <div style={{ textAlign: "center", marginBottom: 32 }}>
        ...
        <div
          style={{
            ...
            borderRadius: 100,
            background:
              "linear-gradient(135deg,rgba(91,138,255,.18),rgba(167,139,250,.18))",
        ...
        >
          <svg width={160} height={160} viewBox="0 0 160 160">
            ...
            <circle
              ...
              style={{
                filter: `drop-shadow(0 0 10px ${sc}88)`,
            ...
            >
              ...
              {stream.subjects.map((s, i) => (
                ...
                >
                  ...
                  />
                  <span
                    style={{ fontSize: ".8rem", color: "rgba(241,245,255,.7)" }}
                  >
                    {s}
                  </span>
                </div>
            ...
            {report.careerMatches?.map((c, i) => (
              <div
                ...
                onMouseEnter={(e) => {
                  ...
                  el.style.borderColor = "rgba(91,138,255,.4)";
                }}
                onMouseLeave={(e) => {
                  const el = e.currentTarget as HTMLElement;
                    ...
                    >
                      <div
                        style={{
                          ...
                          background:
                            i === 0
                              ? "linear-gradient(90deg,#5b8aff,#a78bfa)"
                              : i === 1
                                ? "linear-gradient(90deg,#00C9B1,#2563EB)"
                                : "rgba(255,255,255,.18)",
                          borderRadius: 99,
                          transition: "width 1.2s ease",
                        }}
      ...
      {/* ══ 4. UNIVERSITIES — USA / CANADA / AUSTRALIA / EUROPE ══ */}
      <Box icon="🎓" title="Universities to Consider">
        ...
        >
          {(["USA", "Canada", "Australia", "Europe"] as const).map((region) => (
            <span
              key={region}
              style={{
                display: "inline-flex",
                ...
                padding: "4px 12px",
                borderRadius: 50,
                background: `${REGION_COLOR[region]}18`,
                border: `1px solid ${REGION_COLOR[region]}40`,
                fontSize: ".68rem",
          ...
          {report.universities?.map((u, i) => (
            <a
              ...
              onMouseEnter={(e) => {
                const el = e.currentTarget as HTMLElement;
                el.style.background = "rgba(255,255,255,.07)";
                el.style.borderColor = `${REGION_COLOR[u.region] ?? "#d4af37"}50`;
      ...
      <Box icon="🚀" title="Futuristic Interdisciplinary Careers">
        ...
        >
          Explore the forefront of interdisciplinary career possibilities —
          innovative paths that blend diverse skill sets. These visionary roles
          transcend traditional boundaries, revealing opportunities where
          multidisciplinary expertise is highly valued.
        </p>
          ...
          {report.futuristicCareers?.map((fc, i) => (
            <div
              ...
              style={{
                ...
                borderRadius: 12,
                background:
                  "linear-gradient(135deg,rgba(167,139,250,.06),rgba(91,138,255,.04))",
              ...
              onMouseLeave={(e) => {
                ...
                el.style.background =
                  "linear-gradient(135deg,rgba(167,139,250,.06),rgba(91,138,255,.04))";
                el.style.borderColor = "rgba(167,139,250,.15)";
              }}
            >
              <div
                style={{
      ...
      <Box icon="🧪" title="Aptitude Assessment">
        ...
        >
          Aptitude is your natural ability to learn and excel in certain areas.
          Recognising your strengths early helps in making informed decisions
          about future studies and professions — ensuring a more fulfilling and
            ...
            {report.aptitudeEnhancement?.books?.map((b, i) => (
              <div
                ...
                style={{
                  ...
                  paddingBottom: 10,
                  borderBottom:
                    i < report.aptitudeEnhancement.books.length - 1
              ...
              >
                ...
                <div
                  style={{ fontSize: ".7rem", color: "rgba(241,245,255,.4)" }}
                >
                  by {b.author}
                </div>
              </div>
        ...
        {report.aptitudeEnhancement?.quote && (
          <div
            style={{
              ...
              borderRadius: 12,
              background:
                "linear-gradient(135deg,rgba(212,175,55,.08),rgba(212,175,55,.03))",
          ...
          >
            ...
            >
              "<span style={{ color: "#d4af37" }}>Aptitude</span> ignites
              potential, turning passion into purpose and dreams into reality."
            </p>
          </div>
        )}
      </Box>
      ...
      >
        <Box icon="✨" title="Core Strengths" inline>
          {report.strengths?.map((s, i) => (
            ...
            >
              <span style={{ color: "#34d399", flexShrink: 0, marginTop: 1 }}>
                ✓
              </span>
              <span
                style={{
      ...
      <Box icon="⚙️" title="Skill Assessment">
        ...
        >
          Evaluate the depth and breadth of your skills. This section highlights
          areas of expertise and potential avenues for development — guiding you
          towards where focused effort will amplify your profile most.
        </p>
        <div
                  ...
                  >
                    <div
                      style={{
                        height: "100%",
                        width: `${sk.level}%`,
                        background: scoreColor(sk.level),
                        borderRadius: 99,
                        boxShadow: `0 0 8px ${scoreColor(sk.level)}66`,
                        transition: "width 1.2s ease",
                      }}
                    />
                  </div>
        ...
        <div
          style={{
            background:
              "linear-gradient(135deg,rgba(91,138,255,.06),rgba(167,139,250,.04))",
            border: "1px solid rgba(91,138,255,.15)",
            borderRadius: 12,
            padding: "16px 18px",
          }}
        >
          ...
          >
            YOUR TOP SKILL ATTRIBUTES
          </div>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
            {report.skillAttributes
          ...
          <p
            style={{
              fontSize: ".78rem",
              fontStyle: "italic",
              color: "rgba(241,245,255,.3)",
              marginTop: 14,
              marginBottom: 0,
            }}
          >
            "Skills are your super-power — cultivate them and{" "}
            <span style={{ color: "#d4af37" }}>Conquer the World</span>"
          </p>
        </div>
      </Box>

      {/* ══ 11. PROFILE BUILDING BENEFITS (NEW) ══ */}
      {report.profileBuildingBenefits && (
        <Box icon="💡" title="Why Profile Building Matters">
          ...
          <div style={{ marginBottom: 22 }}>
            ...
            >
              📅 Your Action Timeline by Class
            </div>
            <div
              style={{ display: "flex", flexDirection: "column", gap: 0 }}
            >
              {report.profileBuildingBenefits.timelineByClass?.map(
                (stage, i) => (
                  <div
                    key={i}
                    ...
                    >
                      <div
                        style={{
                          ...
                          borderRadius: "50%",
                          background:
                            CLASS_LEVEL_COLOR[stage.classLevel] ?? "#5b8aff",
                      ...
                      />
                      {i <
                        (report.profileBuildingBenefits.timelineByClass
                          ?.length ?? 0) -
                          1 && (
                        <div
                          style={{
                        ...
                        {stage.actions.map((action, j) => (
                          <div
                            ...
                            style={{
                              ...
                              alignItems: "flex-start",
                              marginBottom:
                                j < stage.actions.length - 1 ? 8 : 0,
                            }}
                          >
                            <span
                              style={{
                                color:
                                  CLASS_LEVEL_COLOR[stage.classLevel] ??
                                  "#5b8aff",
                                fontSize: ".75rem",
                                flexShrink: 0,
                                marginTop: 2,
          ...
          <div
            style={{
              ...
              borderRadius: 14,
              background:
                "linear-gradient(135deg,rgba(212,175,55,.1),rgba(212,175,55,.03))",
          ...
          >
            ...
            >
              {report.profileBuildingBenefits.whyItMatters}
            </p>
          </div>
        </Box>
      )}

      {/* ══ 12. PROFILE BUILDING ROADMAP ══ */}
      <Box icon="🏗️" title="Profile Building Roadmap">
        ...
        >
          Receive personalised recommendations to strengthen your profile —
          tailored guidance on skill enhancement, academic pursuits, and personal
          development aimed at maximising your potential for success.
        </p>
            ...
            >
              <div style={{ flex: 1 }}>
                ...
                >
                  ...
                  {(d as ProfileBuildingItem).classLevel && (
                    <span
                      style={{
                        padding: "2px 8px",
                        borderRadius: 50,
                ...
                {(d as ProfileBuildingItem).benefit && (
                  <div
                    style={{
                      display: "flex",
                      gap: 6,
                  ...
                  >
                    <span style={{ color: "#34d399", fontSize: ".7rem", flexShrink: 0, marginTop: 1 }}>
                      ✓
                    </span>
                    <span
                      style={{
                ...
                {(d as ProfileBuildingItem).importance && (
                  <div
                    style={{
                      display: "flex",
                      gap: 6,
                  ...
                  >
                    <span style={{ color: "#5b8aff", fontSize: ".7rem", flexShrink: 0, marginTop: 1 }}>
                      →
                    </span>
                    <span
                      style={{
              ...
              <span
                style={{
                  ...
                  border: `1px solid ${PRIORITY_COLOR[d.priority] ?? "rgba(255,255,255,.2)"}`,
                  color: PRIORITY_COLOR[d.priority] ?? "rgba(255,255,255,.4)",
                  fontSize: ".62rem",
                  fontWeight: 700,
                  flexShrink: 0,
                }}
        ...
        {/* ── Entrance Exam Recommendations (AI-generated, class-aware) ── */}
        <div style={{ marginBottom: 20 }}>
          <div
            style={{
              fontSize: ".65rem",
          ...
          {(report.profileBuilding?.exams as ExamRecommendation[])?.map(
            (ex, i) => (
              <div
                key={i}
                style={{
                    ...
                    >
                      ...
                      <span
                        style={{
                          ...
                          fontSize: ".62rem",
                          color:
                            CLASS_LEVEL_COLOR[ex.classLevel] ?? "#5b8aff",
                          fontWeight: 700,
                        }}
                      >
                        📅 {ex.classLevel}
                ...
                {ex.whyForYou && (
                  ...
                  >
                    ...
                    <p
                      style={{
                        fontSize: ".78rem",
                        color: "rgba(91,138,255,.9)",
                        lineHeight: 1.6,
                        margin: 0,
                      }}
                    >
                      <strong>Why this exam for you: </strong>
                      {ex.whyForYou}
                    </p>
                  </div>
                )}
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          {report.profileBuilding?.activities?.map((act, i) => (
            ...
            >
              ...
              <span
                style={{ fontSize: ".82rem", color: "rgba(241,245,255,.65)" }}
              >
                {act}
              </span>
            </div>
        ...
        {report.profileBuilding?.importantTip && (
          <div
            style={{
              ...
              borderRadius: 12,
              background:
                "linear-gradient(135deg,rgba(212,175,55,.1),rgba(212,175,55,.04))",
              border: "1px solid rgba(212,175,55,.25)",
              marginBottom: 12,
            }}
          >
        ...
        {report.profileBuilding?.quote && (
          ...
          >
            ...
            <span style={{ color: "#d4af37" }}>Ordinary</span> and{" "}
            <span style={{ color: "#d4af37" }}>Extraordinary</span> is that{" "}
            <span style={{ color: "#d4af37" }}>little extra</span>"
          </p>
        )}
      </Box>

      {/* ══ 13. SCHOLARSHIP INSIGHTS ══ */}
      <Box icon="🎖️" title="Scholarship Insights">
        ...
        >
          Unlock the gateway to educational opportunities. Discover top
          scholarships offered by prestigious global universities — empower your
          academic journey with funding that aligns with your aspirations.
        </p>
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          {report.scholarships?.map((s, i) => (
            <div
              ...
              onMouseEnter={(e) => {
                ...
                el.style.borderColor = "rgba(212,175,55,.2)";
              }}
              onMouseLeave={(e) => {
                const el = e.currentTarget as HTMLElement;
                el.style.background = "rgba(255,255,255,.03)";
                ...
                {c.region && (
                  <span
                    style={{
                      padding: "2px 8px",
                      borderRadius: 50,
                      background: `${REGION_COLOR[c.region] ?? "#5b8aff"}18`,
                      border: `1px solid ${REGION_COLOR[c.region] ?? "#5b8aff"}35`,
                      fontSize: ".6rem",
                      color: REGION_COLOR[c.region] ?? "#5b8aff",
                      fontWeight: 700,
                    }}
                  >
                    {c.region}
      ...
      <Box icon="🤖" title="AI Counsellor Insight">
        <div
          style={{
            ...
            borderRadius: 13,
            background:
              "linear-gradient(135deg,rgba(91,138,255,.09),rgba(167,139,250,.07))",
            border: "1px solid rgba(91,138,255,.2)",
          }}
        >
          <p
      ...
      <div
        style={{
          background: "linear-gradient(135deg,#0B1C3D,#102454)",
          borderRadius: 20,
          padding: "32px 28px",
          textAlign: "center",
          marginBottom: 14,
      ...
      >
        ...
        >
          Matched to your unique personality profile by AI
        </p>
        <div
          style={{
            display: "flex",
      ...
      {report.adminContact && (
        ...
        >
          ...
          >
            <a
              href={`mailto:${report.adminContact.email}`}
              style={{
                display: "flex",
                alignItems: "center",
                gap: 8,
            ...
            <a
              href={`tel:${report.adminContact.phone.replace(/\s/g, "")}`}
              style={{
                display: "flex",
                alignItems: "center",
                gap: 8,
...
function drawRadar(
  ...
  cats: PersonalityReport["categories"]
) {
  ...
  cats.forEach((_, i) => {
    ...
    ctx.fillStyle = "rgba(241,245,255,.45)";
  ...
  g.addColorStop(0, "rgba(0,201,177,.3)");
