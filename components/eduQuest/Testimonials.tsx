...
/* ─── TIMELINE DATA (unchanged from original .ts) ──────────────────────── */
const timelineTabs = [
  {
    id: 'all',
...
/* ─── TESTIMONIAL DATA (unchanged from original .ts) ───────────────────── */
const testimonials = [
  {
    name: 'Hardik',
    score: 'SAT 1520',
  ...
  return (
    <>
      <style>{`
        ...
        /* ── Tabs ── */
        .tl-tabs {
          display: flex; gap: 8px; flex-wrap: wrap; margin-bottom: 36px; margin-top: 48px;
        }
        .tl-tab {
      ...
      <section className="tl-section" id="timeline">
        <div className="tl-inner">
          ...
          <p className="tl-desc">
            Select your current grade to see your personalised action plan for getting into a top global university.
          </p>
          ...
          {/* Stage cards — group steps into logical stage cards */}
