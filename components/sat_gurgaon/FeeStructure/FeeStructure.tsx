...
const fees = [
  ...
  },
  {
    ...
    amount: "₹70,800/-",
    href: "https://eduquest.org.in/product/sat-in-gurgaon-hybridonline-live/",
  },
  {
    label: "Classroom Group Course",
    desc: "In-person at DLF Phase IV centre, Gurgaon",
    amount: "₹55,000/-",
  ...
  },
  {
    ...
    amount: "₹80,000/-",
    href: "https://eduquest.org.in/product/sat-in-gurgaon-one-on-one-online-live/",
  },
  {
    label: "Hybrid One-on-One",
    desc: "Premium: online + classroom + admissions support",
    amount: "₹1,18,000/-",
    href: "https://eduquest.org.in/product/sat-in-gurgaon-hybrid-one-on-oneonline-live/",
  },
];
  ...
  return (
    <section className={styles.section}>
      ...
      <h2 className={styles.heading}>
        SAT Coaching <em>Fee Structure</em> — Gurgaon
      </h2>
