...
testimonials: [
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "How much time is needed to prepare for the SAT?", answer: "The ideal preparation time for the SAT is 2 to 4 months, depending on your current level and target score. Students aiming for top scores (1400+) should plan for 3–4 months of structured preparation, including concept building, regular practice, and full-length mock tests. Beginners may need more time to strengthen fundamentals, while students with a strong academic base can prepare effectively in a shorter duration with focused practice." },
    ],
  },
